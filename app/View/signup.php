...
<main class=" flex items-center relative justify-center min-h-screen  bg-primary/50">
    <div class="max-w-xl w-full bg-white p-5 rounded-lg  shadow-lg my-10">
        <h1 class="font-bold text-3xl lg:text-4xl text-center mb-16 text-neutral-600">Sign Up To <span class="text-primary font-extrabold">GeoAfrica</span></h1>
        <form action=<?= URLROOT . "signup" ?> method="POST">
            ...
            <div class="mb-3">
                <label for="confirm-password" class="block mb-2 text-sm font-medium">Confirm Password</label>
                <input type="password" id="confirm-password" name="confirm-password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" />
            </div>
